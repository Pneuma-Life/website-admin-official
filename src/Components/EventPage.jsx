...
function EventsPage() {
    ...
    const addCalender = () => {
        alert('Event Added your Google Calender')
        setShowForm(false)
    }
        ...
        <div>
            {showForm ?
                ...
                <h1>Upcoming Events</h1>
                                ...
                                <div className="form-group">
                                    <label htmlFor="">Theme of Event</label>
                                    <input type="text" />
                                </div>
                                ...
                                <div className="join-event">
                                    <button onClick={addCalender} className='add-calender'>Add To My Calender</button>
                                </div>
                                <div className="changes">
                                    <button className="edit-button" onClick={UploadForm}>Upload</button>
                                </div>
                            </form>
                        </div>
                    </div >
